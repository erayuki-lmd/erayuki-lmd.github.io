...
function first_style(){
    ...
    root.style.setProperty("--square_bg", 'none');
    root.style.setProperty("--triangle_bg", 'none');
    root.style.setProperty("--triangle_size", '0vw');
    root.style.setProperty("--triangle_size_A", '15vw');
    root.style.setProperty("--triangle_size_B", '20vw');
    root.style.setProperty("--leaf_bg", 'none');
...
function new_style(){
    ...
    root.style.setProperty("--square_bg", 'url("../new_img/new_A.png")');
    root.style.setProperty("--triangle_bg", 'url("../new_img/new_B.png")');
    root.style.setProperty("--triangle_size", '22vw');
    root.style.setProperty("--triangle_size_A", '0vw');
    root.style.setProperty("--triangle_size_B", '0vw');
    root.style.setProperty("--leaf_bg", 'url("../new_img/new_C.png")');
